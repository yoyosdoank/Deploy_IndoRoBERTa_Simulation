...
def get_model():
    ...
    model3 = AutoModelForSequenceClassification.from_pretrained("yogie27/IndoRoBERTa-Hatespeech-Binary-Classifier", token="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")
...
header = st.title("RoBERTa: Prediksi Sentimen, Emosi dan Hate Speech Untuk Media Sosial Bahasa Indonesia.")
